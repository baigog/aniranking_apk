...
## 0.1.6 - 2026-01-06
- More robust backup/restore (file export/import) and more consistent offline restores.
- Search improvements: unbounded results, watchlist/like from search, visible errors, and default adult filtering.
- Explore filters (status/year/genre/order) with cooldown control.
- Updates: better cache/ETag/rate-limit handling and clearer messages.
- Ranking share: image with covers and refined layout.
- Duel/explore stability (retries and pending state).
